...
namespace PixelCrushers.QuestMachine.DialogueSystemSupport
{
    ...
    public class DialogueSystemQuestMachineBridge : MonoBehaviour
    {
        ...
        public virtual bool processQuestMachineTags
        {
            get { return m_processQuestMachineTags; }
            set { m_processQuestMachineTags = value; }
        }

        public virtual bool overrideQuestLog
        {
        ...
        void Awake()
        {
            ...
            else
            {
                ...
                Lua.RegisterFunction("ShowQuestAlert", this, SymbolExtensions.GetMethodInfo(() => ShowQuestAlert(string.Empty)));
        ...
        /// </summary>
        public virtual bool HasGeneratedQuest(string questGiverID, string questerID)
        {
            var questGiver = GetQuestGiver(questGiverID);
            var quester = GetQuester(questerID);
            if (questGiver == null || quester == null) return false;
        ...
        /// </summary>
        public virtual void StartQuestListConversation(string questGiverID)
        {
        ...
        /// </summary>
        public virtual void ShowQuestConversation(string questGiverID, string questID, string questerID)
        {
            var questGiver = GetQuestGiver(questGiverID);
            var quester = GetQuester(questerID);
        ...
        /// </summary>
        public virtual void ShowGeneratedQuestConversation(string questGiverID, string questerID)
        {
            var questGiver = GetQuestGiver(questGiverID);
            var quester = GetQuester(questerID);
            if (questGiver == null || quester == null) return;
        ...
        public virtual void ShowQuestAlert(string message)
        {
            var alertUI = (QuestMachine.defaultQuestAlertUI is DialogueSystemQuestAlertUI)
                ? QuestMachineConfiguration.instance.GetComponentInChildren<UnityUIQuestAlertUI>()
                : QuestMachine.defaultQuestAlertUI;
            if (alertUI == null) alertUI = QuestMachine.defaultQuestAlertUI;
            alertUI.ShowAlert(message);
        }
