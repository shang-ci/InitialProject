    ...
    public class QuestCanvasGUI
    {
        ...
        private bool DoesConditionSetReferenceMe(Quest quest, QuestConditionSet conditionSet)
        {
            foreach (var condition in conditionSet.conditionList)
            {
                ...
                {
                    if (StringField.Equals((condition as QuestStateQuestCondition).questIDToCheck, quest.id))
                    {
                        return true;
                    }
                }
                ...
                {
                    if (StringField.Equals((condition as QuestNodeStateQuestCondition).questIDToCheck, quest.id))
                    {
                        return true;
                    }
                }
