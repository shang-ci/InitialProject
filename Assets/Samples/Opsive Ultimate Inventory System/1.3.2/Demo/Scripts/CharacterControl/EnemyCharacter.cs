...
namespace Opsive.UltimateInventorySystem.Demo.CharacterControl
{
    ...
    public class EnemyCharacter : Character
    {
        ...
        protected override void Awake()
        {
            ...
            m_PlayerCharacter = FindFirstObjectByType<PlayerCharacter>();
#else
        ...
        {
            if (m_SwordCategory == null) { return; }
        ...
        protected override void Update()
        {
            ...
            if (attack) {
                if (m_DemoCharacterEquipper.ItemObjectSlots.Length > 0) {
                    var usableItem = m_DemoCharacterEquipper.ItemObjectSlots[0].ItemObject.gameObject.GetCachedComponent<IItemObjectBehaviourHandler>();
