...
namespace Opsive.UltimateInventorySystem.Demo.UI.Menus.Upgrade
{
    ...
    public class UpgradeMenu : InventoryPanelBinding
    {
        ...
        public override void OnClose()
        {
            ...
            if (m_CharacterStats == null)
            {
                Debug.LogError("The Player Character component was not found, UpgradeMenu is a DEMO script for the ULTIMATE INVENTORY SYSTEM, it is not core functionality. Please copy paste this script and related scripts and make any adjustments you may need.");
                return;
            }
